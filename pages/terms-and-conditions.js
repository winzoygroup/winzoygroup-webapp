    ...
    <Layout title={'Terms and Conditions'}>
      <Box my={4}>
        ...
        >
          ...
          <p>Welcome to Winzoy Group!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Winzoygroup's Website, located at
            https://www.winzoygroup.com/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Winzoy Group if you do not agree
          ...
          <p>
            We employ the use of cookies. By accessing Winzoy Group, you agreed
            to use cookies in agreement with the Winzoygroup's Privacy Policy.{' '}
          </p>
          ...
          <p>
            Unless otherwise stated, Winzoygroup and/or its licensors own the
            intellectual property rights for all material on Winzoy Group. All
            intellectual property rights are reserved. You may access this from
            Winzoy Group for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Winzoy Group</li>
            <li>Sell, rent or sub-license material from Winzoy Group</li>
            <li>Reproduce, duplicate or copy material from Winzoy Group</li>
            <li>Redistribute content from Winzoy Group</li>
          </ul>
          ...
          <p>
            ...
            Winzoygroup does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Winzoygroup,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            Winzoygroup shall not be liable for the Comments or for any
          ...
          <p>
            Winzoygroup reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Winzoygroup a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Winzoygroup;
          ...
          <p>
            ...
            sending an e-mail to Winzoygroup. Please include your name, your
          ...
          <p>
            No use of Winzoygroup's logo or other artwork will be allowed for
